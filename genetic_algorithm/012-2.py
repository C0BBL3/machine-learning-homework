...
nn_chromosome_genes = [ line.strip( '\n' ) for line in open( 'genetic_algorithm/nn_chromosome_genes.txt', 'r' ).readlines() ]
# ^^^^^ tic tac toe chromosome genes

GA = GeneticAlgorithm()
#GA.read_chromosomes( nn_chromosome_genes, population_size = 64 ) ahhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
...
for generation in range( num_generations ):
    ...
    GA.determine_fitness( fitness_score = 'round robin', cutoff_type = 'tournament' )
...
plt.savefig( 'images/012-1-1.png' )
...
plt.savefig( 'images/012-1-2.png' )
