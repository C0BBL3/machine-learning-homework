...
board_states = [ line.strip( '\n' ) for line in open( 'metaheuristic_algorithm/ttt_board_states/board_states.txt', 'r' ).readlines() ]
ttc_chromosome_genes_file = open( 'metaheuristic_algorithm/ttt_board_states/ttc_chromosome_genes.txt', 'w' )
