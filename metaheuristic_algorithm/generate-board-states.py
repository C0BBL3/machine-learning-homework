                            ...
                            for g in [0, 1, 2]:
                                for h in [0, 1, 2]:
                                    for i in [0, 1, 2]:
                                        ...
                                        board_validation = validate_board(
                                            board)

                                        if not board_validation:
                                            continue

                                        board_evaluation = evaluate_board(
                                            board)
...
board_states_file = open(
    'metaheuristic_algorithm/ttt_board_states/board_states.txt', 'w')

for board_state in board_states:
    string_board_state = '\n' + ''.join([str(space) for space in board_state])
    board_states_file.write(string_board_state)

winnable_board_states_file = open(
    'metaheuristic_algorithm/ttt_board_states/winnable_board_states.txt', 'w')

for board_state in winnable_board_states:
    string_board_state = '\n' + ''.join([str(space) for space in board_state])
    winnable_board_states_file.write(string_board_state)

losable_board_states_file = open(
    'metaheuristic_algorithm/ttt_board_states/losable_board_states.txt', 'w')
...
winning_board_states_file = open(
    'metaheuristic_algorithm/ttt_board_states/winning_board_states.txt', 'w')

for board_state in winning_board_states:
    string_board_state = '\n' + ''.join([str(space) for space in board_state])
    winning_board_states_file.write(string_board_state)

losing_board_states_file = open(
    'metaheuristic_algorithm/ttt_board_states/losing_board_states.txt', 'w')
...
tieing_board_states_file = open(
    'metaheuristic_algorithm/ttt_board_states/tieing_board_states.txt', 'w')
